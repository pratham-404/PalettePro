...
xs_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 12)
small_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 14)
medium_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 18)
large_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 24)
xl_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 30)
xxl_font = pg.freetype.Font("assets/fonts/Basic-Regular.ttf", 40)
...
active_overlay = 0
overlays = [
    pg.image.load("assets/images/overlay1.png").convert_alpha(),
    pg.image.load("assets/images/overlay2.png").convert_alpha(),
    pg.image.load("assets/images/overlay3.png").convert_alpha(),
    pg.image.load("assets/images/overlay4.png").convert_alpha(),
    pg.image.load("assets/images/overlay5.png").convert_alpha(),
    pg.image.load("assets/images/overlay6.png").convert_alpha()
]
...
def draw_menu(window, color_palette, option_locks, help_opt):
    ...
    lock_enabled = pg.transform.scale(pg.image.load("assets/images/lock_enabled.png"), (20, 20))
    lock_disabled = pg.transform.scale(pg.image.load("assets/images/lock_disabled.png"), (20, 20))
